...
const We = class {
  ...
  static async fetchLookupIds(l, t, a, i, r, d, v) {
    ...
    if (f) {
      ...
      const p = v.filter((S) => !g.includes(S));
      if (p.length == 0)
        return;
...
}), Lo = ["href", "onClick"], Vo = ["type"], Mo = /* @__PURE__ */ Y({
...
}), So = ["type", "href", "onClick"], Ao = ["type"], To = /* @__PURE__ */ Y({
...
const ri = { key: 0 }, ui = { class: "md:p-4" }, rs = /* @__PURE__ */ Y({
  ...
  Vi
], Si = { class: "flex" }, Ai = /* @__PURE__ */ n("svg", {
  class: "h-6 w-6",
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 20 20",
  fill: "currentColor",
  ...
  setup(e, { emit: l }) {
    ...
    Sl(() => g.value = Object.assign({}, t.column.settings, {
            ...
            n("div", ci, [
              ...
              s(v) ? (o(), u("div", wi, [
                ...
                (o(!0), u(be, null, $e(s(p), (G, te) => (o(), u("div", Ci, [
                  n("span", _i, [
                    he(V(e.column.name) + " " + V(G.name) + " " + V(S(G)) + " ", 1),
                    n("button", {
                      type: "button",
                      onClick: (T) => _(te),
  ...
  setup(e, { expose: l, emit: t }) {
    ...
    }), M = I([]), P = I(new Ze()), ue = I(new Ze()), ie = I(), se = I(!1), H = I(), J = I(), pe = I(!1), _e = I(), ae = I(a.skip), Pe = I(!1), Ae = 25, ge = I({ take: Ae }), Re = I(!1), Me = c(() => M.value.some((x) => x.settings.filters.length > 0 || !!x.settings.sort) || ge.value.selectedColumns), Ne = c(() => M.value.map((x) => x.settings.filters.length).reduce((x, L) => x + L, 0)), Xe = c(() => {
      var x;
    ...
    async function Ft(x, L) {
      ...
      if (W.succeeded) {
        ...
        Se || console.warn(`API ${(Le = me.value.AnyQuery) == null ? void 0 : Le.request.name}(${x}:${L}) returned no results`), J.value = Se;
      }
    }
    ...
    function Cs(x, L) {
      ...
      if (Ee(x) && (ee == null ? void 0 : ee.tagName) !== "TD") {
        let de = (W = ee == null ? void 0 : ee.closest("TABLE")) == null ? void 0 : W.getBoundingClientRect(), Le = M.value.find((Se) => Se.name.toLowerCase() == x.toLowerCase());
        if (Le && de) {
          let Se = 318, ut = de.x + Se + 10;
          _e.value = {
            column: Le,
            topLeft: {
              x: Math.max(Math.floor(L.clientX + Se / 2), ut),
              y: de.y + 45
            }
          };
        }
    ...
    function xl() {
      ...
      if (M.value.forEach((W) => {
        ...
        if (Object.keys(W).forEach((de) => {
          A.value.find((Se) => Se.name === de) && (x[de] = W[de]);
        }), typeof W.skip < "u") {
    ...
    function _n() {
      ...
      x && (ge.value = x), M.value = A.value.map((W) => ({
        name: W.name,
        type: W.type,
        meta: W,
    ...
    return lt(async () => {
      ...
      return s(wn) ? (o(), u("div", hr, [
        ...
        s(G).toolbar ? Z(x.$slots, "toolbar", { key: 2 }) : S("toolbar") ? (o(), u("div", wr, [
          ...
          n("div", xr, [
            ...
            n("div", Ur, [
              ...
              s(Me) && S("resetPreferences") ? (o(), u("div", au, [
                n("button", {
                  type: "button",
                  onClick: Is,
              ...
              S("filtersView") && s(Ne) > 0 ? (o(), u("div", ru, [
                n("button", {
                  type: "button",
              ...
              S("newItem") && s(me).Create && s(Ds) ? (o(), u("div", pu, [
                n("button", {
                  type: "button",
                  onClick: Fs,
                  title: s(st),
        ...
        ue.value.error ?? P.value.error ? (o(), X(Se, {
          key: 5,
  ...
  setup(e) {
    return (l, t) => {
      var a, i, r, d, v, f, m;
      return o(), u("div", Vu, [
        (r = (i = (a = e.column) == null ? void 0 : a.settings) == null ? void 0 : i.filters) != null && r.length ? (o(), u("svg", Mu, Au)) : (o(), u("svg", {
          key: 1,
...
}), bd = ["id"], wd = ["for"], xd = { class: "mt-1 relative rounded-md shadow-sm" }, kd = ["id", "name", "value"], $d = ["onClick"], Cd = { class: "flex flex-wrap pb-1.5" }, _d = { class: "pt-1.5 pl-1" }, Ld = { class: "inline-flex rounded-full items-center py-0.5 pl-2.5 pr-1 text-sm font-medium bg-indigo-100 dark:bg-indigo-800 text-indigo-700 dark:text-indigo-300" }, Vd = ["onClick"], Md = /* @__PURE__ */ n("svg", {
  class: "h-2 w-2",
  stroke: "currentColor",
  fill: "none",
  viewBox: "0 0 8 8"
  ...
  setup(e) {
    ...
    }, S = ($) => $ == null ? !1 : $.startsWith("data:") || $.startsWith("blob:"), O = c(() => {
      if (v.value.length > 0)
          ...
          (o(!0), u(be, null, $e(v.value, (B) => (o(), u("tr", null, [
            n("td", nc, [
              n("div", {
                ...
                S(B.filePath) ? (o(), u("span", ic, V(B.fileName), 1)) : (o(), u("a", {
                  key: 0,
                  href: s(a)(B.filePath || ""),
                  target: "_blank",
                  class: "overflow-hidden"
  ...
  setup(e, { expose: l, emit: t }) {
    ...
    const f = c(() => dt.call({ responseStatus: a.status ?? (v == null ? void 0 : v.error.value) }, a.id)), m = c(() => [ot.base, f.value ? ot.invalid : ot.valid]), g = I(null), p = I(""), h = I(null), b = I(a.viewCount), k = I([]), _ = c(() => p.value ? a.options.filter((y) => a.match(y, p.value)).slice(0, b.value) : a.options), S = ["Tab", "Escape", "ArrowDown", "ArrowUp", "Enter", "PageUp", "PageDown", "Home", "End"];
    function O(T) {
...
`, "	"];
    ...
    function Q(T) {
      ...
      if (!a.multiple || !y) {
        ...
        const A = new RegExp("\\r|\\n|\\t|,"), M = T.split(A).filter((P) => P.trim()).map((P) => a.options.find((ue) => a.match(ue, P))).filter((P) => !!P);
        if (M.length > 0) {
...
}), Vc = ["id", "name", "value"], Mc = { class: "block truncate" }, Sc = /* @__PURE__ */ Y({
  __name: "Combobox",
  props: {
    id: null,
    modelValue: null,
  ...
  setup(e, { emit: l }) {
    ...
    return (f, m) => {
      var O, N, q, Q, $, j, B, D, F, E, K, G, te, T, y, A, le, M, P, ue, ie, se;
      const g = U("SelectInput"), p = U("CheckboxInput"), h = U("TagInput"), b = U("Combobox"), k = U("FileInput"), _ = U("TextareaInput"), S = U("TextInput");
      return s(a) == "select" ? (o(), X(g, Ce({
        ...
        "input-class": (M = e.input.css) == null ? void 0 : M.input,
        "label-class": (P = e.input.css) == null ? void 0 : P.label
      }, s(r)), null, 16, ["id", "modelValue", "status", "input-class", "label-class"])) : (o(), X(S, Ce({
        key: 6,
        type: s(a),
        id: e.input.id,
        modelValue: d.value,
  ...
  setup(e, { emit: l }) {
    const t = e;
    function a(_, S) {
      t.modelValue[_.id] = ce(S, _.id), l("update:modelValue", t.modelValue);
    }
    const { metadataApi: i, apiOf: r, typeOf: d, typeOfRef: v, createFormLayout: f, Crud: m } = Je(), g = c(() => t.type || Tt(t.modelValue)), p = c(() => d(g.value)), h = c(() => {
      var _, S;
      return v((S = (_ = i.value) == null ? void 0 : _.operations.find((O) => O.request.name == g.value)) == null ? void 0 : S.dataModel) || p.value;
    }), b = c(() => {
      const _ = p.value;
      if (!_) {
        if (t.formLayout)
      ...
      const S = Ke(_), O = h.value, N = t.formLayout ? t.formLayout : f(_), q = [], Q = r(_.name);
      return N.forEach(($) => {
        var F;
        const j = S.find((E) => E.name == $.name);
        if ($.ignore)
          return;
                ...
                (o(!0), u(be, null, $e(s(b), ($) => {
                  ...
                  return o(), u("div", {
                    ...
                    ((B = $.prop) == null ? void 0 : B.ref) != null && $.type != "file" && !$.prop.isPrimaryKey ? (o(), X(N, {
                      ...
                      input: $,
                      modelValue: e.modelValue,
                      "onUpdate:modelValue": S[0] || (S[0] = (F) => _.$emit("update:modelValue", F)),
                      api: e.api
...
const Gc = ["onSubmit"], Wc = { key: 0 }, Zc = { key: 2 }, Jc = ["innerHTML"], Xc = /* @__PURE__ */ n("input", {
  ...
  setup(e, { emit: l }) {
    ...
    const f = yl(), { getTypeName: m } = za(), { typeOf: g, Crud: p, createDto: h } = Je(), b = I(new Ze()), k = c(() => typeof t.buttonsClass == "string" ? t.formClass : Ue.buttonsClass), _ = c(() => typeof t.headingClass == "string" ? t.formClass : ht.headingClass), S = c(() => typeof t.subHeadingClass == "string" ? t.subHeadingClass : ht.subHeadingClass), O = c(() => {
      var F;
  ...
  setup(e, { emit: l }) {
    ...
    async function f(M) {
      d.value && d.value(M), r.value = void 0, d.value = void 0;
    }
    const { typeOf: m, typeProperties: g, Crud: p, createDto: h, formValues: b } = Je(), k = c(() => Tt(t.type)), _ = c(() => m(k.value)), S = I(typeof t.type == "string" ? h(t.type) : t.type ? new t.type() : null), O = c(() => t.panelClass || Ue.panelClass(t.formStyle)), N = c(() => t.formClass || Ue.formClass(t.formStyle)), q = c(() => t.headingClass || Ue.headingClass(t.formStyle)), Q = c(() => t.subHeadingClass || Ue.subHeadingClass(t.formStyle)), $ = c(() => t.buttonsClass || Ue.buttonsClass), j = c(() => p.model(_.value)), B = c(() => {
      var M;
      return t.heading || ((M = m(k.value)) == null ? void 0 : M.description) || (j.value ? `New ${Ie(j.value)}` : Ie(k.value));
    }), D = I(new Ze());
    ...
    async function K(M) {
      ...
      let P = M.target;
      if (!t.autosave) {
        l("save", new S.value.constructor(b(P, g(_.value))));
        return;
      }
      ...
      if (ql.hasRequestBody(ue)) {
        ...
        let J = b(P, g(_.value)), pe = new S.value.constructor(J);
    ...
    return lt(() => window.addEventListener("keydown", le)), Ut(() => window.removeEventListener("keydown", le)), (M, P) => {
      var _e, ae, Pe, Ae, ge;
        ...
        s(_) ? e.formStyle == "card" ? (o(), u("div", {
          ...
          n("form", {
            ...
            n("div", {
              ...
              n("div", null, [
                M.$slots.heading ? (o(), u("div", o0, [
                  Z(M.$slots, "heading")
                ])) : (o(), u("h3", {
                  key: 1,
                  class: w(s(q))
                }, V(s(B)), 3)),
                M.$slots.subheading ? (o(), u("div", i0, [
                  Z(M.$slots, "subheading")
                ])) : e.subHeading ? (o(), u("p", {
                  key: 3,
                  class: w(s(Q))
                    ...
                    n("div", v0, [
                      n("div", h0, [
                        n("div", g0, [
                          n("div", p0, [
                            n("div", y0, [
                              M.$slots.heading ? (o(), u("div", b0, [
                                Z(M.$slots, "heading")
                              ])) : (o(), u("h3", {
                                key: 1,
                                class: w(s(q))
                              }, V(s(B)), 3)),
                              M.$slots.subheading ? (o(), u("div", w0, [
                                Z(M.$slots, "subheading")
                              ])) : e.subHeading ? (o(), u("p", {
                                key: 3,
                                class: w(s(Q))
...
}), _0 = { key: 0 }, L0 = { class: "text-red-700" }, V0 = /* @__PURE__ */ n("b", null, "type", -1), M0 = ["onSubmit"], S0 = { key: 0 }, A0 = { key: 2 }, T0 = ["innerHTML"], I0 = { class: "flex justify-end" }, F0 = {
  key: 2,
  class: "relative z-10",
  "aria-labelledby": "slide-over-title",
  role: "dialog",
  ...
  setup(e, { emit: l }) {
    ...
    async function y(H) {
      ...
      let J = H.target;
      if (!t.autosave) {
        l("save", new q.value.constructor(S(J, p(N.value))));
        return;
      }
      ...
      if (ql.hasRequestBody(pe)) {
        ...
        _e ? E.value = await K.apiFormVoid(ge, Me, ze) : E.value = await K.apiForm(ge, Me, ze);
      } else {
        let ge = S(J, p(N.value));
    ...
    At(M, () => {
      Lt(ue, P, M.value), M.value || setTimeout(le, 700);
    }), M.value = !0;
    function ie() {
      t.formStyle == "slideOver" ? M.value = !1 : le();
    }
    const se = (H) => {
      H.key === "Escape" && ie();
    };
            ...
            n("div", {
              ...
              n("div", null, [
                ...
                H.$slots.subheading ? (o(), u("div", A0, [
                  ...
                  key: 3,
                  class: w(s(B))
                }, V(e.subHeading), 3)) : (Me = s(N)) != null && Me.notes ? (o(), u("p", {
                  key: 4,
                  class: w(["notes", s(B)]),
  ...
  setup(e, { emit: l }) {
    ...
    function q(M) {
      const P = t.visibleFrom && ce(t.visibleFrom, M);
    ...
    function te(M, P) {
      return t.rowClass ? t.rowClass(M, P) : oe.getTableRowClass(t.tableStyle, P, !!(t.isSelected && t.isSelected(M)), t.isSelected != null);
    }
    function T(M, P) {
      return t.rowStyle ? t.rowStyle(M, P) : void 0;
    }
    const y = c(() => {
      const M = (typeof t.selectedColumns == "string" ? t.selectedColumns.split(",") : t.selectedColumns) || (m.value.length > 0 ? m.value : Il(t.items)), P = k.value.reduce((ue, ie) => (ue[ie.name.toLowerCase()] = ie.format, ue), {});
      return M.filter((ue) => {
        var ie;
                  ...
                  n("tr", {
                    ...
                    (o(!0), u(be, null, $e(s(y), (se) => (o(), u("td", {
                      ...
                      n("div", {
                        ...
                        s(d)[se + "-header"] ? Z(M.$slots, se + "-header", {
                          key: 0,
                          column: se
                        }) : v(se) ? Z(M.$slots, v(se), {
                          key: 1,
                          column: se
                        }) : s(d).header ? Z(M.$slots, "header", {
                          key: 2,
                          column: se,
                          label: _(se)
                        }) : (o(), u("div", sf, [
                ...
                n("tbody", {
                  ...
                  (o(!0), u(be, null, $e(e.items, (se, H) => (o(), u("tr", {
                    ...
                    (o(!0), u(be, null, $e(s(y), (J) => (o(), u("td", {
                      ...
                      s(d)[J] ? Z(M.$slots, J, _t(Ce({ key: 0 }, se))) : f(J) ? Z(M.$slots, f(J), _t(Ce({ key: 1 }, se))) : S(J) ? (o(), X(ue, {
                        key: 2,
                        type: s(b),
                        propType: S(J),
                        modelValue: se
...
const yf = Y({
...
}), _f = ["innerHTML"], Lf = { key: 0 }, Vf = /* @__PURE__ */ n("b", null, null, -1), Mf = { key: 2 }, Sf = /* @__PURE__ */ Y({
  __name: "HtmlFormat",
  props: {
    value: null,
    depth: { default: 0 },
  ...
  setup(e, { emit: l }) {
    ...
    return lt(() => window.addEventListener("keydown", b)), Ut(() => window.removeEventListener("keydown", b)), (k, _) => {
      ...
      return o(), u("div", {
        ...
        ((O = m.value) == null ? void 0 : O.name) == "ModalLookup" && m.value.ref ? (o(), X(S, {
          key: 0,
...
}, $1 = { class: "px-4 text-lg text-black dark:text-white" }, C1 = { key: 0 }, _1 = { key: 1 }, L1 = /* @__PURE__ */ n("span", { class: "hidden xl:inline" }, " Showing Results ", -1), V1 = { key: 2 }, M1 = {
  key: 1,
  class: "pl-2"
}, S1 = /* @__PURE__ */ n("svg", {
  class: "w-5 h-5",
  ...
  setup(e, { emit: l }) {
    ...
    }), E = c(() => k.value > 0), K = c(() => k.value > 0), G = c(() => D.value.length >= B.value), te = c(() => D.value.length >= B.value), T = I([]), y = c(() => T.value.some((R) => R.settings.filters.length > 0 || !!R.settings.sort)), A = c(() => T.value.map((R) => R.settings.filters.length).reduce((R, z) => R + z, 0)), le = c(() => Kt(Q.value)), M = c(() => {
      var R;
    ...
    async function Ae(R) {
      ...
      z && (z.settings = R, f.setItem(H(z.name), JSON.stringify(z.settings)), await Me()), ie.value = null;
    }
    async function ge(R) {
      f.setItem(H(R.name), JSON.stringify(R.settings)), await Me();
    }
    async function Re(R) {
      ue.value = !1, h.value = R, f.setItem(se(), JSON.stringify(R)), await Me();
    }
    async function Me() {
      await Ne(Xe());
    }
          ...
          default: ve(() => [
            n("div", l1, [
              n("div", n1, [
                ...
                s(y) && e.showResetPreferences ? (o(), u("div", M1, [
                  n("button", {
                    type: "button",
                    onClick: ze,
                    title: "Reset Preferences & Filters",
                ...
                n("div", T1, [
                  e.showFiltersView && s(A) > 0 ? (o(), u("div", I1, [
                    n("button", {
                      type: "button",
                      onClick: z[5] || (z[5] = (ke) => S.value = S.value == "filters" ? null : "filters"),
                      class: w(s(m)),
                      "aria-expanded": "false"
                    }, [
                      F1,
                      n("span", P1, V(s(A)) + " " + V(s(A) == 1 ? "Filter" : "Filters"), 1),
                      S.value != "filters" ? (o(), u("svg", D1, j1)) : (o(), u("svg", B1, E1))
                    ], 2)
                  ])) : C("", !0)
                ])
              ]),
              S.value == "filters" ? (o(), X(dn, {
                ...
                definitions: s(g),
                columns: T.value,
                onDone: z[6] || (z[6] = (ke) => S.value = null),
                onChange: ge
              }, null, 8, ["definitions", "columns"])) : C("", !0),
              ie.value ? (o(), u("div", H1, [
                fe(un, {
  ...
  setup(e, { emit: l }) {
    ...
    const b = c(() => (f == null ? void 0 : f.authProviders.filter((D) => D.formLayout)) || []), k = c(() => b.value[0] || {}), _ = c(() => b.value[Math.max(b.value.length - 1, 0)] || {}), S = c(() => (t.provider ? f == null ? void 0 : f.authProviders.find((D) => D.name === t.provider) : null) ?? k.value), O = (D) => D === !1 || D === "false";
    function N(D) {
      return D.label || D.navItem && D.navItem.label;
    }
    const q = c(() => {
      var D;
      return (((D = S.value) == null ? void 0 : D.formLayout) || []).map((F) => {
        var E, K;
    ...
    async function B() {
      if (p.value.provider = S.value.name, h.value = await r.api(p.value), h.value.succeeded) {
  ...
  DarkModeToggle: rm,
  SignIn: Vm
}, Sm = ["onClick", "title"], Am = /* @__PURE__ */ Y({
  __name: "RouterLink",
  props: {
    to: null
  },
