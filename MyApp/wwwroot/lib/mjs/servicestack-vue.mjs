...
ye(ne, "config", {
  ...
  take: 25,
  maxFieldLength: 150
}), ye(ne, "user", F(null)), ye(ne, "metadata", F(null));
function Ea(e) {
...
const We = class {
  ...
  static async fetchLookupIds(l, t, a, i, r, d, v) {
    ...
    if (f) {
      ...
      const g = v.filter((L) => !h.includes(L));
      if (g.length == 0)
        return;
      const y = d ? null : `${i},${r}`, k = {
        [i + "In"]: g.join(",")
      };
      y && (k.fields = y);
      const b = Ht(f, k), C = await l.api(b, { jsconfig: "edv,eccn" });
      if (C.succeeded)
        (ce(C.response, "results") || []).forEach((V) => {
          if (!ce(V, i)) {
            console.error(`result[${i}] == null`, V);
            return;
          }
          const D = `${ce(V, i)}`, B = ce(V, r);
          r = r.toLowerCase();
          const Q = m[D] ?? (m[D] = {});
          Q[r] = `${B}`;
        });
...
const si = { key: 0 }, ai = { class: "md:p-4" }, as = /* @__PURE__ */ Y({
  ...
  emits: ["done", "save"],
  setup(e, { emit: l }) {
    const t = e, a = F(), i = F(""), r = F(""), d = F([]), v = c(() => t.column.meta.isEnum == !0), f = c(() => t.column.meta.isEnum == !0 ? nn(Jn(t.column.type)) : []), m = c(() => {
      var $;
      return (($ = y(t.column.type)) == null ? void 0 : $.map((R) => ({ key: R.value, value: R.name }))) || [];
    }), h = F({ filters: [] }), g = c(() => h.value.filters);
    Sl(() => h.value = Object.assign({}, t.column.settings, {
      filters: Array.from(t.column.settings.filters)
    })), Sl(() => {
      var $, R, E;
      return d.value = ((E = (R = ($ = t.column.settings.filters) == null ? void 0 : $[0]) == null ? void 0 : R.value) == null ? void 0 : E.split(",")) || [];
    });
    function y($) {
      let R = t.definitions;
      return Qn($) || (R = R.filter((E) => E.types !== "string")), R;
    }
    function k($, R) {
      return y($).find((E) => E.value === R);
    }
    function b() {
      var R;
      if (!i.value)
        return;
      let $ = (R = k(t.column.type, i.value)) == null ? void 0 : R.name;
      $ && (h.value.filters.push({ key: i.value, name: $, value: r.value }), i.value = r.value = "");
    }
    function C($) {
      h.value.filters.splice($, 1);
    }
    function L($) {
      return ts(k(t.column.type, $.key), t.column.type, $);
    }
    function V() {
      l("done");
    }
    ...
    function B() {
      if (r.value && b(), v.value) {
        let $ = Object.values(d.value).filter((R) => R);
        h.value.filters = $.length > 0 ? [{ key: "%In", name: "In", value: $.join(",") }] : [];
      }
      l("save", h.value), l("done");
    }
    function Q($) {
      h.value.sort = $ === h.value.sort ? void 0 : $, ul(B);
    }
    return ($, R) => {
      var K;
      const E = q("SelectInput"), j = q("TextInput"), P = q("PrimaryButton"), N = q("SecondaryButton");
      return o(), u("div", {
            ...
            n("div", ii, [
              ...
              n("div", ui, [
                n("button", {
                  ...
                  onClick: R[0] || (R[0] = (G) => Q("ASC")),
                  class: w(`${h.value.sort === "ASC" ? "bg-indigo-100 border-indigo-500" : "bg-white hover:bg-gray-50 border-gray-300"} mr-1 inline-flex items-center px-2.5 py-1.5 border shadow-sm text-sm font-medium rounded text-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`)
                }, fi, 2),
                n("button", {
                  type: "button",
                  title: "Sort Descending",
                  onClick: R[1] || (R[1] = (G) => Q("DESC")),
                  class: w(`${h.value.sort === "DESC" ? "bg-indigo-100 border-indigo-500" : "bg-white hover:bg-gray-50 border-gray-300"} ml-1 inline-flex items-center px-2.5 py-1.5 border shadow-sm text-sm font-medium rounded text-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`)
                }, vi, 2)
              ]),
              hi,
              s(v) ? (o(), u("div", gi, [
                ...
                (o(!0), u(be, null, $e(s(g), (G, te) => (o(), u("div", wi, [
                  n("span", xi, [
                    he(S(e.column.name) + " " + S(G.name) + " " + S(L(G)) + " ", 1),
                    n("button", {
                      type: "button",
                      onClick: (I) => C(te),
                ...
                n("div", _i, [
                  ...
                  ((K = k(e.column.type, i.value)) == null ? void 0 : K.valueType) !== "none" ? (o(), X(j, {
                    key: 0,
                    ref_key: "txtFilter",
                    ref: a,
                    id: "filterValue",
  ...
  setup(e, { emit: l }) {
    ...
    function i(g) {
      var y, k;
      return (k = (y = g == null ? void 0 : g[0]) == null ? void 0 : y.value) == null ? void 0 : k.split(",");
    }
    function r(g) {
      let y = t.definitions;
      return Qn(g) || (y = y.filter((k) => k.types !== "string")), y;
    }
    function d(g, y) {
      return r(g).find((k) => k.value === y);
    }
    function v(g, y) {
    ...
    return (g, y) => (o(), u("div", Si, [
      n("div", Ai, [
        (o(!0), u(be, null, $e(s(a), (k) => (o(), u("fieldset", Ti, [
          n("legend", Ii, [
            n("span", null, S(s(Ie)(k.name)), 1),
            n("span", Fi, [
              n("span", Pi, [
                n("button", {
                  onClick: (b) => f(k),
                  title: `Clear all ${s(Ie)(k.name)} filters`,
          ...
          k.meta.isEnum ? (o(), u("div", Bi, [
            (o(!0), u(be, null, $e(i(k.settings.filters), (b) => (o(), u("div", {
              key: b,
              class: "flex items-center"
            }, [
              n("label", Ri, S(b), 1)
            ...
            (o(!0), u(be, null, $e(k.settings.filters, (b, C) => (o(), u("div", Hi, [
              n("span", Ni, [
                he(S(k.name) + " " + S(b.name) + " " + S(v(k, b)) + " ", 1),
                n("button", {
                  type: "button",
                  onClick: (L) => m(k, C),
                  class: "flex-shrink-0 ml-0.5 h-4 w-4 rounded-full inline-flex items-center justify-center text-indigo-400 hover:bg-indigo-200 hover:text-indigo-500 focus:outline-none focus:bg-indigo-500 focus:text-white"
  ...
  emits: ["done", "save"],
  setup(e, { emit: l }) {
    const t = e, { autoQueryGridDefaults: a } = wt(), i = F({});
            ...
            n("div", Wi, [
              n("div", Zi, [
                ...
                n("div", Xi, [
                  ...
                  gt(n("select", {
                    id: `${e.id}-take`,
                    "onUpdate:modelValue": m[0] || (m[0] = (k) => i.value.take = k),
                    ...
                    (o(!0), u(be, null, $e(r.filter((k) => t.maxLimit == null || k <= t.maxLimit), (k) => (o(), u("option", {
                      value: k,
                      selected: k === i.value.take
                    }, S(k), 9, tr))), 256))
                  ], 8, er), [
                    [Bs, i.value.take]
                  ])
                ...
                n("div", lr, [
                  n("input", {
                    type: "radio",
                    id: `${e.id}-allColumns`,
                    onClick: m[1] || (m[1] = (k) => i.value.selectedColumns = []),
                ...
                n("div", ar, [
                  n("div", or, [
                    n("div", ir, [
                      (o(!0), u(be, null, $e(e.columns, (k) => (o(), u("div", {
                        key: k.name,
                        class: "flex items-center"
                      }, [
                        gt(n("input", {
                          ...
                          id: k.name,
                          value: k.name,
                          "onUpdate:modelValue": m[2] || (m[2] = (b) => i.value.selectedColumns = b),
  ...
  setup(e, { expose: l, emit: t }) {
    ...
    const g = "filtering,queryString,queryFilters".split(","), y = "copyApiUrl,downloadCsv,filtersView,newItem,pagingInfo,pagingNav,preferences,refresh,resetPreferences,toolbar".split(","), k = c(() => a.deny ? h(g, a.deny) : h(g, d.value.deny)), b = c(() => a.hide ? h(y, a.hide) : h(y, d.value.hide));
    function C(x) {
      return k.value[x];
    }
    function L(x) {
    ...
    const V = c(() => a.tableStyle ?? d.value.tableStyle), D = c(() => a.gridClass ?? oe.getGridClass(V.value)), B = c(() => a.grid2Class ?? oe.getGrid2Class(V.value)), Q = c(() => a.grid3Class ?? oe.getGrid3Class(V.value)), $ = c(() => a.grid4Class ?? oe.getGrid4Class(V.value)), R = c(() => a.tableClass ?? oe.getTableClass(V.value)), E = c(() => a.theadClass ?? oe.getTheadClass(V.value)), j = c(() => a.theadRowClass ?? oe.getTheadRowClass(V.value)), P = c(() => a.theadCellClass ?? oe.getTheadCellClass(V.value)), N = c(() => a.toolbarButtonClass ?? oe.toolbarButtonClass);
    function K(x, M) {
      var Le;
      if (a.rowClass)
        return a.rowClass(x, M);
      const ee = !!me.value.AnyUpdate, de = ((Le = ze.value) != null && Le.name ? ce(x, ze.value.name) : null) == z.value;
    ...
    const G = Nl(), te = c(() => {
      ...
      const x = Object.keys(G).map((M) => M.toLowerCase());
      return Ke(te.value).filter((M) => x.includes(M.name.toLowerCase()) || x.includes(M.name.toLowerCase() + "-header")).map((M) => M.name);
    });
    function p() {
      let x = m(a.selectedColumns);
      return x.length > 0 ? x : I.value.length > 0 ? I.value : [];
    }
    const T = c(() => {
      ...
      let x = T.value.map((ee) => ee.name), M = m(ge.value.selectedColumns).map((ee) => ee.toLowerCase());
      return M.length > 0 ? x.filter((ee) => M.includes(ee.toLowerCase())) : x;
    }), A = F([]), O = F(new Ze()), ue = F(new Ze()), ie = F(), se = F(!1), z = F(), J = F(), pe = F(!1), _e = F(), ae = F(a.skip), Pe = F(!1), Ae = 25, ge = F({ take: Ae }), Re = F(!1), Me = c(() => A.value.some((x) => x.settings.filters.length > 0 || !!x.settings.sort) || ge.value.selectedColumns), Ne = c(() => A.value.map((x) => x.settings.filters.length).reduce((x, M) => x + M, 0)), Xe = c(() => {
      var x;
    ...
    }), H = c(() => ge.value.take ?? Ae), U = c(() => O.value.response ? ce(O.value.response, "results") : []), re = c(() => {
      var x;
      return ((x = O.value.response) == null ? void 0 : x.total) ?? U.value.length ?? 0;
    }), xe = c(() => ae.value > 0), we = c(() => ae.value > 0), Fe = c(() => U.value.length >= H.value), qe = c(() => U.value.length >= H.value), ke = {
    ...
    function Ee(x) {
      if (x) {
        ...
        const M = Xe.value.find((ee) => ee.name.toLowerCase() == x.toLowerCase());
        if (M)
          return !Kn(M);
      }
      return !1;
    ...
    async function rt(x) {
      ...
      const M = Math.floor(re.value / H.value) * H.value;
      ae.value > M && (ae.value = M), Qe({ skip: ae.value || void 0 }), await Ge();
    }
    async function Ft(x, M) {
      var de, Le;
      if (J.value = null, z.value = M, !x || !M)
        return;
      let ee = Ht(me.value.AnyQuery, { [x]: M });
      const W = await v.api(ee);
      if (W.succeeded) {
        let Se = (de = ce(W.response, "results")) == null ? void 0 : de[0];
        Se || console.warn(`API ${(Le = me.value.AnyQuery) == null ? void 0 : Le.request.name}(${x}:${M}) returned no results`), J.value = Se;
      }
    }
    async function ws(x, M) {
      var de;
      t("rowSelected", x, M);
    ...
    function xs(x, M) {
      ...
      if (Ee(x) && (ee == null ? void 0 : ee.tagName) !== "TD") {
        let de = (W = ee == null ? void 0 : ee.closest("TABLE")) == null ? void 0 : W.getBoundingClientRect(), Le = A.value.find((Se) => Se.name.toLowerCase() == x.toLowerCase());
        if (Le && de) {
    ...
    async function $s(x) {
      ...
      M && (M.settings = x, f.setItem(Wt(M.name), JSON.stringify(M.settings)), await Ge()), _e.value = null;
    }
    async function Cs(x) {
    ...
    function vn(x = "json") {
      ...
      return W.indexOf("?") >= 0 ? cl(W, "?") + "." + x + "?" + Zs(W, "?") : W + ".json";
    }
    async function Ss() {
      A.value.forEach((x) => {
    ...
    const xt = c(() => Tt(a.type)), st = c(() => {
      ...
      var M;
      return `Column/${a.id}:${xt.value || ((M = me.value.AnyQuery) == null ? void 0 : M.dataModel.name)}.${x}`;
      ...
      let x = m(a.apis);
      return x.length > 0 ? Mt.from(x.map((M) => gn(M)).filter((M) => M != null).map((M) => M)) : Mt.forType(xt.value, hn.value);
    }), Zt = (x) => `<span class="text-yellow-700">${x}</span>`, yn = c(() => {
      if (!hn.value)
    ...
    function Pt() {
      J.value = null, z.value = null, Qe({ edit: void 0 });
    }
    function Dt() {
    ...
    function $n() {
      var ee;
      O.value = new Ze(), ue.value = new Ze(), se.value = !1, z.value = null, J.value = null, pe.value = !1, _e.value = null, ae.value = a.skip, Pe.value = !1, ge.value = { take: Ae }, Re.value = !1;
      const x = a.prefs || il(f.getItem(kl()));
      x && (ge.value = x), A.value = T.value.map((W) => ({
        name: W.name,
        type: W.type,
        meta: W,
    ...
    return lt(async () => {
      ...
      return s(yn) ? (o(), u("div", cr, [
        ...
        s(G).toolbar ? Z(x.$slots, "toolbar", { key: 2 }) : L("toolbar") ? (o(), u("div", gr, [
          pe.value ? (o(), X(un, {
            key: 0,
            columns: s(T),
            prefs: ge.value,
          ...
          n("div", pr, [
            ...
            L("pagingInfo") ? (o(), u("div", Pr, [
              n("div", Dr, [
                Re.value ? (o(), u("span", Or, "Querying...")) : _("", !0),
                s(U).length ? (o(), u("span", jr, [
                  Br,
                  he(" " + S(ae.value + 1) + " - " + S(Math.min(ae.value + s(U).length, s(re))) + " ", 1),
                  n("span", null, " of " + S(s(re)), 1)
                ])) : O.value.completed ? (o(), u("span", Rr, "No Results")) : _("", !0)
              ])
            ])) : _("", !0),
            n("div", Er, [
              L("refresh") ? (o(), u("div", Hr, [
                n("button", {
                  type: "button",
                  onClick: Ls,
                  title: "Refresh",
              ...
              s(Me) && L("resetPreferences") ? (o(), u("div", tu, [
                n("button", {
                  type: "button",
                  onClick: Ss,
              ...
              L("filtersView") && s(Ne) > 0 ? (o(), u("div", su, [
                n("button", {
                  type: "button",
              ...
              L("newItem") && s(me).Create && s(Is) ? (o(), u("div", mu, [
                n("button", {
                  type: "button",
                  onClick: As,
                  title: s(st),
        ...
        s(U).length ? (o(), X(Xt, {
          ...
          header: ve(({ column: Ve, label: ct }) => {
            var Ot;
            return [
              C("filtering") && Ee(Ve) ? (o(), u("div", yu, [
                n("span", bu, S(ct), 1),
                fe(Cn, {
                  column: A.value.find((Fs) => Fs.name.toLowerCase() === Ve.toLowerCase()),
    ...
    return (y, k) => (o(), u("div", {
      ...
      n("div", Ru, [
        n("input", Ce({
          ...
          placeholder: s(f),
          value: e.modelValue,
          onInput: k[0] || (k[0] = (b) => y.$emit("update:modelValue", a(b.target))),
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: l }) {
    const t = e, a = c(() => typeof t.modelValue == "string" ? t.modelValue.trim().length == 0 ? [] : t.modelValue.split(",") : t.modelValue || []), i = F(), r = F(!1), d = c(() => !t.allowableValues || t.allowableValues.length == 0 ? [] : t.allowableValues.filter((p) => !a.value.includes(p) && p.toLowerCase().includes(m.value.toLowerCase())));
    function v(p) {
      i.value = p;
    }
    const f = F(null), m = F(""), h = c(() => t.type || "text"), g = c(() => t.label ?? Ie(Ye(t.id)));
    let y = Oe("ApiState", void 0);
    const k = c(() => dt.call({ responseStatus: t.status ?? (y == null ? void 0 : y.error.value) }, t.id)), b = c(() => [
      ...
      t.inputClass
    ]), C = (p) => $(a.value.filter((T) => T != p));
    function L(p) {
      var T;
      document.activeElement === p.target && ((T = f.value) == null || T.focus());
    }
    const V = F();
    function D() {
      r.value = !0, V.value = !0;
    ...
    function Q() {
      G(E()), V.value = !1, setTimeout(() => {
        V.value || (r.value = !1);
      }, 200);
    }
    function $(p) {
      const T = t.string ? p.join(",") : p;
      l("update:modelValue", T);
    }
    function R(p) {
      if (p.key == "Backspace" && m.value.length == 0 && a.value.length > 0 && C(a.value[a.value.length - 1]), !(!t.allowableValues || t.allowableValues.length == 0))
        if (p.code == "Escape" || p.code == "Tab")
          r.value = !1;
        else if (p.code == "Home")
          i.value = d.value[0], N();
        else if (p.code == "End")
          i.value = d.value[d.value.length - 1], N();
        else if (p.code == "ArrowDown") {
          if (r.value = !0, !i.value)
            i.value = d.value[0];
          else {
            const T = d.value.indexOf(i.value);
            i.value = T + 1 < d.value.length ? d.value[T + 1] : d.value[0];
          }
          K();
          ...
          if (!i.value)
            ...
            const T = d.value.indexOf(i.value);
            i.value = T - 1 >= 0 ? d.value[T - 1] : d.value[d.value.length - 1];
          }
          K();
        } else
    ...
    function N() {
      setTimeout(() => {
        ...
        p && p.scrollIntoView(P);
      }, 0);
    }
    function K() {
      setTimeout(() => {
        let p = ol(`#${t.id}-tag li.active`);
        p && ("scrollIntoViewIfNeeded" in p ? p.scrollIntoViewIfNeeded(P) : p.scrollIntoView(P));
      }, 0);
    }
    function G(p) {
      if (p.length === 0)
        return;
      const T = Array.from(a.value);
      T.indexOf(p) == -1 && T.push(p), $(T), m.value = "", r.value = !1;
    }
    function te(p) {
      var le;
      const T = (le = p.clipboardData) == null ? void 0 : le.getData("Text");
      I(T);
    }
    function I(p) {
      if (!p)
      ...
      p.split(T).map((O) => O.trim()).forEach((O) => {
    ...
    return (p, T) => (o(), u("div", {
      ...
      n("div", pd, [
          ...
          n("div", wd, [
            ...
            n("div", Ld, [
              gt(n("input", Ce({
                ...
                "onUpdate:modelValue": T[0] || (T[0] = (le) => m.value = le),
                "aria-invalid": s(k) != null,
                "aria-describedby": `${e.id}-error`,
                onKeydown: R,
                onKeypress: j,
        ...
        s(k) ? (o(), u("div", Td, Fd)) : _("", !0)
      ]),
      s(k) ? (o(), u("p", {
        key: 1,
        class: "mt-2 text-sm text-red-500",
        id: `${e.id}-error`
      }, S(s(k)), 9, Pd)) : e.help ? (o(), u("p", {
        key: 2,
        class: "mt-2 text-sm text-gray-500",
        id: `${e.id}-description`
      }, S(e.help), 9, Dd)) : _("", !0)
  ...
  setup(e) {
    var Q;
    const l = e, t = F(null), { assetsPathResolver: a, fallbackPathResolver: i } = wt(), r = {}, d = F(), v = F(((Q = l.files) == null ? void 0 : Q.map(f)) || []);
    function f($) {
    ...
    const y = c(() => dt.call({ responseStatus: l.status ?? (g == null ? void 0 : g.error.value) }, l.id)), k = c(() => [
      ...
      let R = $.target;
      d.value = "", v.value = Array.from(R.files || []).map((E) => ({
        fileName: E.name,
        filePath: Zl(E),
        contentLength: E.size,
        contentType: E.type || Ol(E.name)
      }));
    }, C = () => {
      var $;
      return ($ = t.value) == null ? void 0 : $.click();
    }, L = ($) => $ == null ? !1 : $.startsWith("data:") || $.startsWith("blob:"), V = c(() => {
      if (v.value.length > 0)
        return v.value[0].filePath;
      let $ = typeof l.modelValue == "string" ? l.modelValue : l.values && l.values[0];
      return $ && mt(a($)) || null;
    }), D = ($) => !$ || $.startsWith("data:") || $.endsWith(".svg") ? "" : "rounded-full object-cover";
    function B($) {
      d.value = i(V.value);
    }
    return Ut(Nn), ($, R) => (o(), u("div", {
      ...
      e.multiple ? (o(), u("div", Jd, [
        n("table", Xd, [
          (o(!0), u(be, null, $e(v.value, (E) => (o(), u("tr", null, [
            n("td", Yd, [
              n("div", {
                class: "flex w-full",
                title: L(E.filePath) ? "" : E.filePath
              }, [
                n("img", {
                  src: r[s(mt)(E.filePath)] || s(a)(s(mt)(E.filePath)),
                  class: w(["mr-2 h-8 w-8", D(E.filePath)]),
                  onError: (j) => r[s(mt)(E.filePath)] = s(i)(s(mt)(E.filePath))
                }, null, 42, tc),
                L(E.filePath) ? (o(), u("span", nc, S(E.fileName), 1)) : (o(), u("a", {
                  key: 0,
                  href: s(a)(E.filePath || ""),
                  target: "_blank",
                  class: "overflow-hidden"
            ...
            n("td", sc, [
              E.contentLength && E.contentLength > 0 ? (o(), u("span", ac, S(s(Xl)(E.contentLength)), 1)) : _("", !0)
            ])
          ]))), 256))
        ])
      ])) : (o(), u("div", Gd, [
  ...
  setup(e, { expose: l, emit: t }) {
    ...
    l({ toggle: N });
    function r(I) {
      return Array.isArray(a.modelValue) && a.modelValue.indexOf(I) >= 0;
    }
    const d = c(() => a.label ?? Ie(Ye(a.id)));
    let v = Oe("ApiState", void 0);
    const f = c(() => dt.call({ responseStatus: a.status ?? (v == null ? void 0 : v.error.value) }, a.id)), m = c(() => [ot.base, f.value ? ot.invalid : ot.valid]), h = F(null), g = F(""), y = F(null), k = F(a.viewCount), b = F([]), C = c(() => g.value ? a.options.filter((p) => a.match(p, g.value)).slice(0, k.value) : a.options), L = ["Tab", "Escape", "ArrowDown", "ArrowUp", "Enter", "PageUp", "PageDown", "Home", "End"];
    function V(I) {
      y.value = I, b.value.indexOf(I) > Math.floor(k.value * 0.9) && (k.value += a.viewCount, te());
    }
    const D = [",", `
`, "	"];
    function B(I) {
      var T;
      const p = (T = I.clipboardData) == null ? void 0 : T.getData("Text");
      Q(p);
    }
    function Q(I) {
      if (!I)
        return;
      const p = D.some((T) => I.includes(T));
      if (!a.multiple || !p) {
        const T = a.options.filter((le) => a.match(le, I));
        T.length == 1 && (G(T[0]), i.value = !1, tl());
      } else if (p) {
        const T = new RegExp("\\r|\\n|\\t|,"), A = I.split(T).filter((O) => O.trim()).map((O) => a.options.find((ue) => a.match(ue, O))).filter((O) => !!O);
        if (A.length > 0) {
    ...
    function R(I) {
      if (!(I.shiftKey || I.ctrlKey || I.altKey)) {
        if (!i.value) {
          I.code == "ArrowDown" && (i.value = !0, y.value = b.value[0]);
          return;
        }
        if (I.code == "Escape" || I.code == "Tab")
          i.value = !1;
        else if (I.code == "Home")
          y.value = b.value[0], j();
        else if (I.code == "End")
          y.value = b.value[b.value.length - 1], j();
        else if (I.code == "ArrowDown") {
          if (!y.value)
            y.value = b.value[0];
          else {
            const p = b.value.indexOf(y.value);
            y.value = p + 1 < b.value.length ? b.value[p + 1] : b.value[0];
          }
          P();
        } else if (I.code == "ArrowUp") {
          if (!y.value)
            y.value = b.value[b.value.length - 1];
          else {
            const p = b.value.indexOf(y.value);
            y.value = p - 1 >= 0 ? b.value[p - 1] : b.value[b.value.length - 1];
          }
          P();
        } else
          I.code == "Enter" && (y.value ? (G(y.value), a.multiple || (I.preventDefault(), tl())) : i.value = !1);
      }
    }
    const E = { behavior: "smooth", block: "nearest", inline: "nearest", scrollMode: "if-needed" };
    function j() {
      setTimeout(() => {
        let I = ol(`#${a.id}-autocomplete li.active`);
        I && I.scrollIntoView(E);
      }, 0);
    }
    function P() {
      setTimeout(() => {
        let I = ol(`#${a.id}-autocomplete li.active`);
        I && ("scrollIntoViewIfNeeded" in I ? I.scrollIntoViewIfNeeded(E) : I.scrollIntoView(E));
      }, 0);
    }
    function N(I) {
      var p;
      i.value = I, I && (K(), (p = h.value) == null || p.focus());
    }
    function K() {
      i.value = !0, te();
    }
    function G(I) {
      if (g.value = "", i.value = !1, a.multiple) {
        ...
        r(I) ? p = p.filter((T) => T != I) : p.push(I), y.value = null, t("update:modelValue", p);
      } else {
        let p = I;
        a.modelValue == I && (p = null), t("update:modelValue", p);
      }
    }
    function te() {
      b.value = C.value;
    }
    return At(g, te), (I, p) => (o(), u("div", {
      ...
      n("div", uc, [
        ...
        i.value ? (o(), u("ul", {
          ...
          (o(!0), u(be, null, $e(b.value, (T) => (o(), u("li", {
            class: w([T === y.value ? "active bg-indigo-600 text-white" : "text-gray-900 dark:text-gray-100", "relative cursor-default select-none py-2 pl-3 pr-9"]),
            onMouseover: (le) => V(T),
            onClick: (le) => G(T),
            role: "option",
            tabindex: "-1"
          }, [
            Z(I.$slots, "item", _t(al(T))),
            r(T) ? (o(), u("span", {
              key: 0,
              class: w(["absolute inset-y-0 right-0 flex items-center pr-4", T === y.value ? "text-white" : "text-indigo-600"])
            }, gc, 2)) : _("", !0)
          ], 42, vc))), 256))
        ], 40, mc)) : !e.multiple && e.modelValue ? (o(), u("div", {
          key: 1,
          onKeydown: R,
          onClick: p[3] || (p[3] = (T) => N(!i.value)),
          class: "h-8 -mt-8 ml-3 pt-0.5"
        }, [
          Z(I.$slots, "item", _t(al(e.modelValue)))
        ], 32)) : _("", !0),
  ...
  setup(e, { expose: l, emit: t }) {
    ...
    const r = c(() => a.multiple != null ? a.multiple : Array.isArray(a.modelValue)), d = F();
    function v(g, y) {
      return !y || g.value.toLowerCase().includes(y.toLowerCase());
    }
    const f = c(() => a.entries || (a.values ? a.values.map((g) => ({ key: g, value: g })) : a.options ? Object.keys(a.options).map((g) => ({ key: g, value: a.options[g] })) : [])), m = F(r.value ? [] : null);
    lt(() => {
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: l }) {
    const t = e, a = c(() => t.input.type || "text"), i = "ignore,css,options,meta,allowableValues,allowableEntries,op,prop,type,id,name".split(","), r = c(() => nt(t.input, i)), d = F(De(
    ...
    return (f, m) => {
      var V, D, B, Q, $, R, E, j, P, N, K, G, te, I, p, T, le, A, O, ue, ie, se;
      const h = q("SelectInput"), g = q("CheckboxInput"), y = q("TagInput"), k = q("Combobox"), b = q("FileInput"), C = q("TextareaInput"), L = q("TextInput");
      return s(a) == "select" ? (o(), X(h, Ce({
        key: 0,
        id: e.input.id,
        modelValue: d.value,
        "onUpdate:modelValue": m[0] || (m[0] = (z) => d.value = z),
        ...
        id: e.input.id,
        modelValue: d.value,
        "onUpdate:modelValue": m[2] || (m[2] = (z) => d.value = z),
      ...
      }, s(r)), null, 16, ["id", "modelValue", "status", "input-class", "label-class", "allowableValues", "string"])) : s(a) == "combobox" ? (o(), X(k, Ce({
        key: 3,
        id: e.input.id,
        modelValue: d.value,
        "onUpdate:modelValue": m[3] || (m[3] = (z) => d.value = z),
        ...
        entries: e.input.allowableEntries,
        values: e.input.allowableValues
      }, s(r)), null, 16, ["id", "modelValue", "status", "input-class", "label-class", "entries", "values"])) : s(a) == "file" ? (o(), X(b, Ce({
        key: 4,
        id: e.input.id,
        status: (I = e.api) == null ? void 0 : I.error,
        modelValue: d.value,
        "onUpdate:modelValue": m[4] || (m[4] = (z) => d.value = z),
        "input-class": (p = e.input.css) == null ? void 0 : p.input,
        "label-class": (T = e.input.css) == null ? void 0 : T.label,
        files: s(v)
      }, s(r)), null, 16, ["id", "status", "modelValue", "input-class", "label-class", "files"])) : s(a) == "textarea" ? (o(), X(C, Ce({
        key: 5,
        id: e.input.id,
        modelValue: d.value,
        "onUpdate:modelValue": m[5] || (m[5] = (z) => d.value = z),
      ...
      }, s(r)), null, 16, ["id", "modelValue", "status", "input-class", "label-class"])) : (o(), X(L, Ce({
        key: 6,
        type: s(a),
        id: e.input.id,
        modelValue: d.value,
  ...
  setup(e, { emit: l }) {
    ...
    let v = Oe("ApiState", void 0);
    const f = Oe("client"), m = c(() => dt.call({ responseStatus: t.status ?? (v == null ? void 0 : v.error.value) }, r.value)), h = F(""), g = F(""), y = c(() => ce(t.modelValue, r.value)), k = c(() => Ke(t.metadataType).find((D) => D.name.toLowerCase() == r.value.toLowerCase())), b = c(() => {
      var D, B, Q;
      return ((Q = it((B = (D = k.value) == null ? void 0 : D.ref) == null ? void 0 : B.model)) == null ? void 0 : Q.icon) || a.value.tableIcon;
    });
    let C;
    function L(D) {
      if (D) {
        ...
        C.openModal({ name: "ModalLookup", ref: D }, (B) => {
          if (console.debug("openModal", h.value, " -> ", B, vt.setRefValue(D, B), D), B) {
            const Q = ce(B, D.refId);
            h.value = vt.setRefValue(D, B) || Q;
    ...
    return lt(async () => {
      var j, P;
      C = Oe("ModalProvider", void 0);
      const D = t.modelValue;
      t.modelValue[r.value] || (t.modelValue[r.value] = null);
      const B = k.value, Q = B == null ? void 0 : B.ref;
      if (!Q) {
        console.warn(`No RefInfo for property '${r.value}'`);
        return;
      }
      h.value = "";
      let $ = Q.selfId == null ? ce(D, B.name) : ce(D, Q.selfId);
      if (Et($) && ($ = ce(D, Q.refId)), $ == null)
        return;
      if (((j = i.value) == null ? void 0 : j.operations.find((N) => {
        var K;
        return ((K = N.dataModel) == null ? void 0 : K.name) == Q.model;
      })) != null) {
        const N = ce(D, B.name);
        if (Et(N))
          return;
        if (h.value = `${N}`, g.value = B.name, Q.refLabel != null) {
          ...
          const G = K != null ? ce(D, K.name) : null;
          if (G != null) {
            let te = ce(G, Q.refLabel);
            te && (h.value = `${te}`, vt.setValue(Q.model, $, Q.refLabel, te));
          } else {
            const te = ((P = B.attributes) == null ? void 0 : P.some((p) => p.name == "Computed")) == !0;
            let I = await vt.getOrFetchValue(f, i.value, Q.model, Q.refId, Q.refLabel, te, $);
            h.value = I || `${Q.model}: ${h.value}`;
          }
        }
      }
    }), (D, B) => {
  ...
  setup(e, { emit: l }) {
    const t = e;
    function a(C, L) {
      t.modelValue[C.id] = ce(L, C.id), l("update:modelValue", t.modelValue);
    }
    const { metadataApi: i, apiOf: r, typeOf: d, typeOfRef: v, createFormLayout: f, Crud: m } = Je(), h = c(() => t.type || Tt(t.modelValue)), g = c(() => d(h.value)), y = c(() => {
      var C, L;
      return v((L = (C = i.value) == null ? void 0 : C.operations.find((V) => V.request.name == h.value)) == null ? void 0 : L.dataModel) || g.value;
    }), k = c(() => {
      const C = g.value;
      if (!C) {
        if (t.formLayout)
          return t.formLayout.map(($) => {
            const R = { name: $.id, type: Ya($.type) }, E = Object.assign({ prop: R }, $);
            return t.configureField && t.configureField(E), E;
          });
        throw new Error(`MetadataType for ${h.value} not found`);
      }
      const L = Ke(C), V = y.value, D = t.formLayout ? t.formLayout : f(C), B = [], Q = r(C.name);
      return D.forEach(($) => {
        var P;
        const R = L.find((N) => N.name == $.name);
        if ($.ignore)
          return;
        const E = ((P = V == null ? void 0 : V.properties) == null ? void 0 : P.find((N) => {
          var K;
          return N.name.toLowerCase() == ((K = $.name) == null ? void 0 : K.toLowerCase());
        })) ?? R, j = Object.assign({ prop: E, op: Q }, $);
        t.configureField && t.configureField(j), B.push(j);
      }), B;
    }), b = c(() => k.value.filter((C) => C.type != "hidden").map((C) => C.id));
    return (C, L) => {
      var Q;
      const V = q("ErrorSummary"), D = q("LookupInput"), B = q("DynamicInput");
      return o(), u(be, null, [
              ...
              n("fieldset", {
                ...
                (o(!0), u(be, null, $e(s(k), ($) => {
                  ...
                  return o(), u("div", {
                    ...
                    class: w([
                      "w-full",
                      ((R = $.css) == null ? void 0 : R.field) ?? ($.type == "textarea" ? "col-span-12" : "col-span-12 xl:col-span-6" + ($.type == "checkbox" ? " flex items-center" : "")),
                      $.type == "hidden" ? "hidden" : ""
                    ])
                  }, [
                    ((E = $.prop) == null ? void 0 : E.ref) != null && $.type != "file" && !$.prop.isPrimaryKey ? (o(), X(D, {
                      key: 0,
                      metadataType: s(y),
                      input: $,
                      ...
                      input: $,
                      modelValue: e.modelValue,
                      "onUpdate:modelValue": L[0] || (L[0] = (P) => C.$emit("update:modelValue", P)),
                      api: e.api
...
function yl() {
  const e = F(!1), l = F(), t = F(), a = Oe("client");
  function i({ message: b, errorCode: C, fieldName: L, errors: V }) {
    return C || (C = "Exception"), V || (V = []), l.value = L ? new Ll({
      errorCode: C,
      message: b,
      errors: [new _n({ fieldName: L, errorCode: C, message: b })]
    }) : new Ll({ errorCode: C, message: b, errors: V });
  }
  function r({ fieldName: b, message: C, errorCode: L }) {
    if (L || (L = "Exception"), !l.value)
      i({ fieldName: b, message: C, errorCode: L });
    else {
      let V = new Ll(l.value);
      V.errors = [
        ...(V.errors || []).filter((D) => {
          var B;
          return ((B = D.fieldName) == null ? void 0 : B.toLowerCase()) !== (b == null ? void 0 : b.toLowerCase());
        }),
        new _n({ fieldName: b, message: C, errorCode: L })
      ], l.value = V;
    }
  }
  async function d(b, C, L) {
    e.value = !0;
    let V = await a.api(kt(b), C, L);
    return e.value = !1, t.value = V.response, l.value = V.error, V;
  }
  async function v(b, C, L) {
    e.value = !0;
    let V = await a.apiVoid(kt(b), C, L);
    return e.value = !1, t.value = V.response, l.value = V.error, V;
  }
  async function f(b, C, L, V) {
    e.value = !0;
    let D = await a.apiForm(kt(b), C, L, V);
    return e.value = !1, t.value = D.response, l.value = D.error, D;
  }
  async function m(b, C, L, V) {
    e.value = !0;
    let D = await a.apiFormVoid(kt(b), C, L, V);
    return e.value = !1, t.value = D.response, l.value = D.error, D;
  }
  function h(b, C) {
    return Rt(`swr.${Ys(b)}`, C ? Object.assign({}, b, C) : b);
  }
  function g(b) {
    const C = ne.config.storage.getItem(b);
    return C ? JSON.parse(C) : null;
  }
  async function y(b, C, L, V) {
    const D = h(b, L);
    C(new Ze({ response: g(D) }));
    const B = await a.api(b, L, V);
    if (B.succeeded && B.response) {
      B.response._date = new Date().valueOf();
      const Q = JSON.stringify(B.response);
      ne.config.storage.setItem(D, Q), C(B);
    }
    return B;
  }
  let k = { setError: i, addFieldError: r, loading: e, error: l, api: d, apiVoid: v, apiForm: f, apiFormVoid: m, swr: y, unRefs: kt, setRef: On };
  return qt("ApiState", k), k;
}
const Uc = ["onSubmit"], qc = { key: 0 }, Qc = { key: 2 }, Kc = ["innerHTML"], Gc = /* @__PURE__ */ n("input", {
  ...
  setup(e, { emit: l }) {
    ...
    async function v(P) {
      r.value && r.value(P), i.value = void 0, r.value = void 0;
    }
    const f = yl(), { getTypeName: m } = Ra(), { typeOf: h, Crud: g, createDto: y } = Je(), k = F(new Ze()), b = c(() => typeof t.buttonsClass == "string" ? t.formClass : Ue.buttonsClass), C = c(() => typeof t.headingClass == "string" ? t.formClass : ht.headingClass), L = c(() => typeof t.subHeadingClass == "string" ? t.subHeadingClass : ht.subHeadingClass), V = c(() => {
      var P;
      return t.type ? m(t.type) : (P = t.modelValue) != null && P.getTypeName ? t.modelValue.getTypeName() : null;
    }), D = c(() => h(V.value)), B = F(t.modelValue || R()), Q = c(() => f.loading.value), $ = c(() => {
      var P;
      return t.heading || ((P = h(V.value)) == null ? void 0 : P.description) || Ie(V.value);
    });
    function R() {
    ...
    async function E(P) {
      ...
      if (Ul.hasRequestBody(G)) {
        let p = new K.constructor(), T = new FormData(N);
        console.debug("AutoForm.submitForm", p, T), te ? k.value = await f.apiFormVoid(p, T, { jsconfig: I }) : k.value = await f.apiForm(p, T, { jsconfig: I });
      } else {
        let p = new K.constructor(B.value);
        console.debug("AutoForm.submit", p), te ? k.value = await f.apiVoid(p, { jsconfig: I }) : k.value = await f.api(p, { jsconfig: I });
      }
      k.value.succeeded ? l("success", k.value.response) : l("error", k.value.error);
    }
    function j(P) {
    ...
    return (P, N) => {
      var p, T, le;
      const K = q("AutoFormFields"), G = q("FormLoading"), te = q("PrimaryButton"), I = q("ModalLookup");
      return s(D) ? (o(), u("form", {
        key: 0,
        onSubmit: je(E, ["prevent"]),
        autocomplete: "off",
        class: w(e.formClass)
      }, [
        n("div", {
          ...
          n("div", {
            ...
            n("div", {
              ...
              P.$slots.heading ? (o(), u("div", qc, [
                Z(P.$slots, "heading")
              ])) : (o(), u("h3", {
                key: 1,
                class: w(s(C))
              }, S(s($)), 3)),
              P.$slots.subheading ? (o(), u("div", Qc, [
                Z(P.$slots, "subheading")
              ])) : e.subHeading ? (o(), u("p", {
                key: 3,
                class: w(s(L))
              }, S(e.subHeading), 3)) : (p = s(D)) != null && p.notes ? (o(), u("p", {
                key: 4,
                class: w(["notes", s(L)]),
                innerHTML: (T = s(D)) == null ? void 0 : T.notes
              }, null, 10, Kc)) : _("", !0)
            ], 2),
            Z(P.$slots, "header"),
            Gc,
          ...
          Z(P.$slots, "buttons", {}, () => [
            n("div", {
              ...
              n("div", null, [
                e.showLoading && s(Q) ? (o(), X(G, { key: 0 })) : _("", !0)
              ]),
              n("div", Wc, [
                Zc,
                fe(te, null, {
        ...
        ((le = i.value) == null ? void 0 : le.name) == "ModalLookup" && i.value.ref ? (o(), X(I, {
          key: 0,
  ...
  setup(e, { emit: l }) {
    ...
    async function f(A) {
      d.value && d.value(A), r.value = void 0, d.value = void 0;
    }
    const { typeOf: m, typeProperties: h, Crud: g, createDto: y, formValues: k } = Je(), b = c(() => Tt(t.type)), C = c(() => m(b.value)), L = F(typeof t.type == "string" ? y(t.type) : t.type ? new t.type() : null), V = c(() => t.panelClass || Ue.panelClass(t.formStyle)), D = c(() => t.formClass || Ue.formClass(t.formStyle)), B = c(() => t.headingClass || Ue.headingClass(t.formStyle)), Q = c(() => t.subHeadingClass || Ue.subHeadingClass(t.formStyle)), $ = c(() => t.buttonsClass || Ue.buttonsClass), R = c(() => g.model(C.value)), E = c(() => {
      var A;
      return t.heading || ((A = m(b.value)) == null ? void 0 : A.description) || (R.value ? `New ${Ie(R.value)}` : Ie(b.value));
    }), j = F(new Ze());
    let P = yl(), N = c(() => P.loading.value);
    async function K(A) {
      var se, z;
      let O = A.target;
      if (!t.autosave) {
        l("save", new L.value.constructor(k(O, h(C.value))));
        return;
      }
      let ue = De((se = L.value) == null ? void 0 : se.getMethod, (J) => typeof J == "function" ? J() : null) || "POST", ie = De((z = L.value) == null ? void 0 : z.createResponse, (J) => typeof J == "function" ? J() : null) == null;
      if (Ul.hasRequestBody(ue)) {
        let J = new L.value.constructor(), pe = new FormData(O);
        ie ? j.value = await P.apiFormVoid(J, pe, { jsconfig: "eccn" }) : j.value = await P.apiForm(J, pe, { jsconfig: "eccn" });
      } else {
        let J = k(O, h(C.value)), pe = new L.value.constructor(J);
        ie ? j.value = await P.apiVoid(pe, { jsconfig: "eccn" }) : j.value = await P.api(pe, { jsconfig: "eccn" });
      }
    ...
    At(te, () => {
      Lt(p, I, te.value), te.value || setTimeout(G, 700);
    }), te.value = !0;
    function T() {
    ...
    return lt(() => window.addEventListener("keydown", le)), Ut(() => window.removeEventListener("keydown", le)), (A, O) => {
      var _e, ae, Pe, Ae, ge;
      const ue = q("AutoFormFields"), ie = q("FormLoading"), se = q("SecondaryButton"), z = q("PrimaryButton"), J = q("CloseButton"), pe = q("ModalLookup");
      return o(), u("div", null, [
        s(C) ? e.formStyle == "card" ? (o(), u("div", {
          key: 1,
          class: w(s(V))
        }, [
          n("form", {
            ...
            n("div", {
              ...
              n("div", null, [
                A.$slots.heading ? (o(), u("div", l0, [
                  Z(A.$slots, "heading")
                ])) : (o(), u("h3", {
                  key: 1,
                  class: w(s(B))
                }, S(s(E)), 3)),
                A.$slots.subheading ? (o(), u("div", n0, [
                  Z(A.$slots, "subheading")
                ])) : e.subHeading ? (o(), u("p", {
                  key: 3,
                  class: w(s(Q))
                }, S(e.subHeading), 3)) : (_e = s(C)) != null && _e.notes ? (o(), u("p", {
                  key: 4,
                  class: w(["notes", s(Q)]),
                  innerHTML: (ae = s(C)) == null ? void 0 : ae.notes
                }, null, 10, s0)) : _("", !0)
              ]),
              Z(A.$slots, "header"),
              fe(ue, {
            ...
            n("div", {
              ...
              n("div", null, [
                e.showLoading && s(N) ? (o(), X(ie, { key: 0 })) : _("", !0)
              ]),
              n("div", a0, [
                e.showCancel ? (o(), X(se, {
                  key: 0,
                    ...
                    n("div", d0, [
                      n("div", c0, [
                        n("div", f0, [
                          n("div", m0, [
                            n("div", v0, [
                              A.$slots.heading ? (o(), u("div", h0, [
                                Z(A.$slots, "heading")
                              ])) : (o(), u("h3", {
                                key: 1,
                                class: w(s(B))
                              }, S(s(E)), 3)),
                              A.$slots.subheading ? (o(), u("div", g0, [
                                Z(A.$slots, "subheading")
                              ])) : e.subHeading ? (o(), u("p", {
                                key: 3,
                                class: w(s(Q))
                              }, S(e.subHeading), 3)) : (Pe = s(C)) != null && Pe.notes ? (o(), u("p", {
                                key: 4,
                                class: w(["notes", s(Q)]),
                                innerHTML: (Ae = s(C)) == null ? void 0 : Ae.notes
                              }, null, 10, p0)) : _("", !0)
  ...
  setup(e, { emit: l }) {
    ...
    async function f(z) {
      d.value && d.value(z), r.value = void 0, d.value = void 0;
    }
    const { typeOf: m, apiOf: h, typeProperties: g, createFormLayout: y, getPrimaryKey: k, Crud: b, createDto: C, formValues: L } = Je(), V = c(() => Tt(t.type)), D = c(() => m(V.value)), B = F(typeof t.type == "string" ? C(t.type, nl(t.modelValue)) : t.type ? new t.type(nl(t.modelValue)) : null), Q = c(() => t.panelClass || Ue.panelClass(t.formStyle)), $ = c(() => t.formClass || Ue.formClass(t.formStyle)), R = c(() => t.headingClass || Ue.headingClass(t.formStyle)), E = c(() => t.subHeadingClass || Ue.subHeadingClass(t.formStyle)), j = c(() => b.model(D.value)), P = c(() => {
      var z;
      return t.heading || ((z = m(V.value)) == null ? void 0 : z.description) || (j.value ? `Update ${Ie(j.value)}` : Ie(V.value));
    }), N = F(new Ze());
    let K = yl(), G = c(() => K.loading.value);
    const te = () => De(m(b.model(D.value)), (z) => k(z));
    function I(z) {
      const { op: J, prop: pe } = z;
      J && (b.isPatch(J) || b.isUpdate(J)) && (z.disabled = pe == null ? void 0 : pe.isPrimaryKey), t.configureField && t.configureField(z);
    }
    async function p(z) {
      var Pe, Ae;
      let J = z.target;
      if (!t.autosave) {
        l("save", new B.value.constructor(L(J, g(D.value))));
        return;
      }
      ...
      if (Ul.hasRequestBody(pe)) {
        ...
        ae && !Array.from(Me.keys()).some((H) => H.toLowerCase() == ae.name.toLowerCase()) && Me.append(ae.name, Re);
        let Ne = [];
        const Xe = V.value && h(V.value);
        if (Xe && b.isPatch(Xe)) {
          let H = nl(t.modelValue), U = y(D.value), re = {};
          if (ae && (re[ae.name] = Re), U.forEach((we) => {
            let Fe = we.id, qe = ce(H, Fe);
        ...
        _e ? N.value = await K.apiFormVoid(ge, Me, ze) : N.value = await K.apiForm(ge, Me, ze);
      } else {
        let ge = L(J, g(D.value));
        ae && !ce(ge, ae.name) && (ge[ae.name] = ce(t.modelValue, ae.name));
        let Re = new B.value.constructor(ge);
        _e ? N.value = await K.apiVoid(Re, { jsconfig: "eccn" }) : N.value = await K.api(Re, { jsconfig: "eccn" });
      }
      N.value.succeeded ? (J.reset(), l("save", N.value.response)) : l("error", N.value.error);
    }
    async function T(z) {
      let J = te();
      ...
      const _e = { [J.name]: pe }, ae = typeof t.deleteType == "string" ? C(t.deleteType, _e) : t.deleteType ? new t.deleteType(_e) : null;
      De(ae.createResponse, (Ae) => typeof Ae == "function" ? Ae() : null) == null ? N.value = await K.apiVoid(ae) : N.value = await K.api(ae), N.value.succeeded ? l("delete", N.value.response) : l("error", N.value.error);
    }
    function le() {
      l("done");
    }
    ...
    At(A, () => {
      Lt(ue, O, A.value), A.value || setTimeout(le, 700);
    }), A.value = !0;
    function ie() {
      t.formStyle == "slideOver" ? A.value = !1 : le();
    }
    const se = (z) => {
      z.key === "Escape" && ie();
    };
    return lt(() => window.addEventListener("keydown", se)), Ut(() => window.removeEventListener("keydown", se)), (z, J) => {
      var Me, Ne, Xe, ze, H;
      ...
      return o(), u("div", null, [
        s(D) ? e.formStyle == "card" ? (o(), u("div", {
          ...
          n("form", {
            ...
            n("div", {
              ...
              n("div", null, [
                z.$slots.heading ? (o(), u("div", _0, [
                  Z(z.$slots, "heading")
                ])) : (o(), u("h3", {
                  key: 1,
                  class: w(s(R))
                }, S(s(P)), 3)),
                z.$slots.subheading ? (o(), u("div", L0, [
                  Z(z.$slots, "subheading")
                ])) : e.subHeading ? (o(), u("p", {
                  key: 3,
                  class: w(s(E))
                }, S(e.subHeading), 3)) : (Me = s(D)) != null && Me.notes ? (o(), u("p", {
                  key: 4,
                  class: w(["notes", s(E)]),
                  innerHTML: (Ne = s(D)) == null ? void 0 : Ne.notes
                }, null, 10, V0)) : _("", !0)
              ]),
              Z(z.$slots, "header"),
              fe(pe, {
          ...
          n("div", T0, [
            n("div", {
              ...
              n("div", {
                ...
                n("div", {
                  class: w(["pointer-events-auto w-screen xl:max-w-3xl md:max-w-xl max-w-lg", O.value])
                }, [
                  n("form", {
                    class: w(s($)),
                    onSubmit: je(p, ["prevent"])
                    ...
                    n("div", F0, [
                      n("div", P0, [
                        n("div", D0, [
                          n("div", O0, [
                            n("div", j0, [
                              z.$slots.heading ? (o(), u("div", B0, [
                                Z(z.$slots, "heading")
                              ])) : (o(), u("h3", {
                                key: 1,
                                class: w(s(R))
                              }, S(s(P)), 3)),
                              z.$slots.subheading ? (o(), u("div", R0, [
                                Z(z.$slots, "subheading")
                              ])) : e.subHeading ? (o(), u("p", {
                                key: 3,
                                class: w(s(E))
                              }, S(e.subHeading), 3)) : (Xe = s(D)) != null && Xe.notes ? (o(), u("p", {
                                key: 4,
                                class: w(["notes", s(E)]),
                                innerHTML: (ze = s(D)) == null ? void 0 : ze.notes
                              }, null, 10, E0)) : _("", !0)
                            ]),
                            n("div", H0, [
                              fe(ge, {
        ...
        ((H = r.value) == null ? void 0 : H.name) == "ModalLookup" && r.value.ref ? (o(), X(Re, {
          key: 3,
          "ref-info": r.value.ref,
          onDone: f
        }, null, 8, ["ref-info"])) : _("", !0)
  ...
  emits: ["headerSelected", "rowSelected"],
  setup(e, { emit: l }) {
    const t = e, a = F(), i = F(null), r = (A) => i.value === A, d = Nl(), v = (A) => Object.keys(d).find((O) => O.toLowerCase() == A.toLowerCase() + "-header"), f = (A) => Object.keys(d).find((O) => O.toLowerCase() == A.toLowerCase()), m = c(() => Il(t.items).filter((A) => !!(d[A] || d[A + "-header"]))), { typeOf: h, typeProperties: g } = Je(), y = c(() => Tt(t.type)), k = c(() => h(y.value)), b = c(() => g(k.value));
    function C(A) {
      const O = t.headerTitles && ce(t.headerTitles, A) || A;
      return t.headerTitle ? t.headerTitle(O) : Fn(O);
    }
    function L(A) {
      const O = A.toLowerCase();
      return b.value.find((ue) => ue.name.toLowerCase() == O);
    }
    function V(A) {
      const O = L(A);
    ...
    function B(A) {
      const O = t.visibleFrom && ce(t.visibleFrom, A);
      return O && De(D[O], (ue) => `hidden ${ue}`);
    }
    const Q = c(() => t.gridClass ?? oe.getGridClass(t.tableStyle)), $ = c(() => t.grid2Class ?? oe.getGrid2Class(t.tableStyle)), R = c(() => t.grid3Class ?? oe.getGrid3Class(t.tableStyle)), E = c(() => t.grid4Class ?? oe.getGrid4Class(t.tableStyle)), j = c(() => t.tableClass ?? oe.getTableClass(t.tableStyle)), P = c(() => t.tbodyClass ?? oe.getTbodyClass(t.tbodyClass)), N = c(() => t.theadClass ?? oe.getTheadClass(t.tableStyle)), K = c(() => t.theadRowClass ?? oe.getTheadRowClass(t.tableStyle)), G = c(() => t.theadCellClass ?? oe.getTheadCellClass(t.tableStyle));
    function te(A, O) {
      return t.rowClass ? t.rowClass(A, O) : oe.getTableRowClass(t.tableStyle, O, !!(t.isSelected && t.isSelected(A)), t.isSelected != null);
    }
    function I(A, O) {
      return t.rowStyle ? t.rowStyle(A, O) : void 0;
    }
    const p = c(() => {
      const A = (typeof t.selectedColumns == "string" ? t.selectedColumns.split(",") : t.selectedColumns) || (m.value.length > 0 ? m.value : Il(t.items)), O = b.value.reduce((ue, ie) => (ue[ie.name.toLowerCase()] = ie.format, ue), {});
      return A.filter((ue) => {
        var ie;
            ...
            n("div", {
              ...
              n("table", {
                ...
                n("thead", {
                  ...
                  n("tr", {
                    ...
                    (o(!0), u(be, null, $e(s(p), (se) => (o(), u("td", {
                      class: w([B(se), s(G), r(se) ? "text-gray-900 dark:text-gray-50" : "text-gray-500 dark:text-gray-400"])
                    }, [
                      n("div", {
                        onClick: (z) => T(z, se)
                      }, [
                        s(d)[se + "-header"] ? Z(A.$slots, se + "-header", {
                          key: 0,
                          column: se
                        }) : v(se) ? Z(A.$slots, v(se), {
                          key: 1,
                          column: se
                        }) : s(d).header ? Z(A.$slots, "header", {
                          key: 2,
                          column: se,
                          label: C(se)
                        }) : (o(), u("div", ef, [
                ...
                n("tbody", {
                  ...
                  (o(!0), u(be, null, $e(e.items, (se, z) => (o(), u("tr", {
                    class: w(te(se, z)),
                    style: El(I(se, z)),
                    onClick: (J) => le(J, z, se)
                  }, [
                    (o(!0), u(be, null, $e(s(p), (J) => (o(), u("td", {
                      class: w([B(J), s(oe).tableCellClass])
                    }, [
                      s(d)[J] ? Z(A.$slots, J, _t(Ce({ key: 0 }, se))) : f(J) ? Z(A.$slots, f(J), _t(Ce({ key: 1 }, se))) : L(J) ? (o(), X(ue, {
                        key: 2,
                        type: s(k),
                        propType: L(J),
                        modelValue: se
...
const vf = Y({
  ...
  setup(e, { attrs: l }) {
    ...
    return () => {
      ...
      if (!m)
        return f;
      const g = Ke(e.type).find((D) => D.type === m.model);
      if (!g)
        return f;
      const y = ce(e.modelValue, g.name), k = y && m.refLabel && ce(y, m.refLabel);
      if (!k)
        return f;
      const b = t(m.model), C = b == null ? void 0 : b.icon, L = C ? ft(ls, { image: C, class: "w-5 h-5 mr-1" }) : null;
                ...
                n("table", {
                  ...
                  n("tbody", null, [
                    (o(!0), u(be, null, $e(e.value, (g, y) => (o(), u("tr", {
                      class: w(e.classes("array", "tr", e.depth, y % 2 == 0 ? "bg-white" : "bg-gray-50", y))
                    }, [
                      (o(!0), u(be, null, $e(s(d), (k) => (o(), u("td", {
  ...
  setup(e, { emit: l }) {
    ...
    async function y(b) {
      h.value && h.value(b), m.value = void 0, h.value = void 0;
    }
    const k = (b) => {
      b.key === "Escape" && v();
    };
    return lt(() => window.addEventListener("keydown", k)), Ut(() => window.removeEventListener("keydown", k)), (b, C) => {
      var V;
      const L = q("ModalLookup");
      return o(), u("div", {
        id: e.id,
        ...
        ((V = m.value) == null ? void 0 : V.name) == "ModalLookup" && m.value.ref ? (o(), X(L, {
          key: 0,
  ...
  emits: ["done"],
  setup(e, { emit: l }) {
    const t = e, a = Nl(), { config: i } = wt(), { metadataApi: r, filterDefinitions: d } = Je(), v = Oe("client"), f = i.value.storage, m = c(() => t.toolbarButtonClass ?? oe.toolbarButtonClass), h = c(() => d.value), g = 25, y = F({ take: g }), k = F(new Ze()), b = F(t.skip), C = F(!1), L = F(), V = (H) => typeof H == "string" ? H.split(",") : H || [];
    function D(H, U) {
      return oe.getTableRowClass("fullWidth", U, !1, !0);
    }
    function B() {
      let H = V(t.selectedColumns);
      return H.length > 0 ? H : [];
    }
    const Q = c(() => it(t.refInfo.model)), $ = c(() => {
      let U = B().map((xe) => xe.toLowerCase());
      const re = Ke(Q.value);
      return U.length > 0 ? U.map((xe) => re.find((we) => we.name.toLowerCase() === xe)).filter((xe) => xe != null) : re;
    }), R = c(() => {
      let H = $.value.map((re) => re.name), U = V(y.value.selectedColumns).map((re) => re.toLowerCase());
      return U.length > 0 ? H.filter((re) => U.includes(re.toLowerCase())) : H;
    }), E = c(() => y.value.take ?? g), j = c(() => k.value.response ? ce(k.value.response, "results") : []), P = c(() => {
      var H;
      return ((H = k.value.response) == null ? void 0 : H.total) ?? j.value.length ?? 0;
    }), N = c(() => b.value > 0), K = c(() => b.value > 0), G = c(() => j.value.length >= E.value), te = c(() => j.value.length >= E.value), I = F([]), p = c(() => I.value.some((H) => H.settings.filters.length > 0 || !!H.settings.sort)), T = c(() => I.value.map((H) => H.settings.filters.length).reduce((H, U) => H + U, 0)), le = c(() => Kt(Q.value)), A = c(() => {
      var H;
      return (H = r.value) == null ? void 0 : H.operations.find((U) => {
        var re;
        return ((re = U.dataModel) == null ? void 0 : re.name) == t.refInfo.model && Te.isAnyQuery(U);
      });
    }), O = F(), ue = F(!1), ie = F(), se = () => `${t.id}/ApiPrefs/${t.refInfo.model}`, z = (H) => `Column/${t.id}:${t.refInfo.model}.${H}`;
    async function J(H) {
      b.value += H, b.value < 0 && (b.value = 0);
      var U = Math.floor(P.value / E.value) * E.value;
      b.value > U && (b.value = U), await Me();
    }
    async function pe(H, U) {
      l("done", H);
    }
    function _e() {
      l("done", null);
    ...
    function ae(H, U) {
      ...
      if ((re == null ? void 0 : re.tagName) !== "TD") {
        let qe = (xe = re == null ? void 0 : re.closest("TABLE")) == null ? void 0 : xe.getBoundingClientRect(), ke = I.value.find((Ee) => Ee.name.toLowerCase() == H.toLowerCase());
        if (ke && qe) {
          let Ee = 318, rt = (((we = U.target) == null ? void 0 : we.tagName) === "DIV" ? U.target : (Fe = U.target) == null ? void 0 : Fe.closest("DIV")).getBoundingClientRect(), Ft = Ee + 25;
          ie.value = {
            column: ke,
            topLeft: {
    ...
    async function Ae(H) {
      var re;
      let U = (re = ie.value) == null ? void 0 : re.column;
      U && (U.settings = H, f.setItem(z(U.name), JSON.stringify(U.settings)), await Me()), ie.value = null;
    }
    async function ge(H) {
      f.setItem(z(H.name), JSON.stringify(H.settings)), await Me();
    }
    async function Re(H) {
      ue.value = !1, y.value = H, f.setItem(se(), JSON.stringify(H)), await Me();
    }
    async function Me() {
      await Ne(Xe());
    }
    async function Ne(H) {
      ...
      let re = Ht(U, H), xe = In((qe) => {
        k.value.response = k.value.error = void 0, C.value = qe;
      }), we = await v.api(re);
      xe(), ul(() => k.value = we);
    ...
    function Xe() {
      let H = {
        include: "total",
        take: E.value
      }, U = V(y.value.selectedColumns || t.selectedColumns);
      if (U.length > 0) {
        let xe = le.value;
        xe && U.includes(xe.name) && (U = [xe.name, ...U]), H.fields = U.join(",");
      }
      let re = [];
      return I.value.forEach((xe) => {
        xe.settings.sort && re.push((xe.settings.sort === "DESC" ? "-" : "") + xe.name), xe.settings.filters.forEach((we) => {
          let Fe = we.key.replace("%", xe.name);
          H[Fe] = we.value;
        });
      }), typeof H.skip > "u" && b.value > 0 && (H.skip = b.value), re.length > 0 && (H.orderBy = re.join(",")), H;
    }
    async function ze() {
      I.value.forEach((H) => {
        H.settings = { filters: [] }, f.removeItem(z(H.name));
      }), await Me();
    }
    return lt(async () => {
      const H = t.prefs || il(f.getItem(se()));
      H && (y.value = H), I.value = $.value.map((U) => ({
        name: U.name,
        type: U.type,
        meta: U,
        settings: Object.assign(
          ...
          il(f.getItem(z(U.name)))
        )
      })), isNaN(t.skip) || (b.value = t.skip), await Me();
    }), (H, U) => {
        ...
        e.refInfo ? (o(), X(qe, {
          ...
          default: ve(() => [
            n("div", Xf, [
              n("div", Yf, [
                ...
                n("div", l1, [
                  e.showPreferences ? (o(), u("button", {
                    ...
                    onClick: U[0] || (U[0] = (ke) => ue.value = !ue.value)
                  }, a1, 8, n1)) : _("", !0),
                  e.showPagingNav ? (o(), u("button", {
                    key: 1,
                    type: "button",
                    class: w(["pl-2", s(N) ? "text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400" : "text-gray-400 dark:text-gray-500"]),
                    title: "First page",
                    disabled: !s(N),
                    onClick: U[1] || (U[1] = (ke) => J(-s(P)))
                  }, r1, 10, o1)) : _("", !0),
                  e.showPagingNav ? (o(), u("button", {
                    key: 2,
                    type: "button",
                  ...
                  e.showPagingNav ? (o(), u("button", {
                    ...
                    title: "Last page",
                    disabled: !s(te),
                    onClick: U[4] || (U[4] = (ke) => J(s(P)))
                  }, p1, 10, h1)) : _("", !0)
                ]),
                e.showPagingInfo ? (o(), u("div", y1, [
                  n("div", b1, [
                    C.value ? (o(), u("span", w1, "Querying...")) : _("", !0),
                    s(j).length ? (o(), u("span", x1, [
                      k1,
                      he(" " + S(b.value + 1) + " - " + S(Math.min(b.value + s(j).length, s(P))) + " ", 1),
                      n("span", null, " of " + S(s(P)), 1)
                    ])) : k.value.completed ? (o(), u("span", $1, "No Results")) : _("", !0)
                  ])
                ])) : _("", !0),
                ...
                n("div", V1, [
                  e.showFiltersView && s(T) > 0 ? (o(), u("div", M1, [
                    n("button", {
                      type: "button",
                      onClick: U[5] || (U[5] = (ke) => L.value = L.value == "filters" ? null : "filters"),
                      class: w(s(m)),
                      "aria-expanded": "false"
                    }, [
                      S1,
                      n("span", A1, S(s(T)) + " " + S(s(T) == 1 ? "Filter" : "Filters"), 1),
                      L.value != "filters" ? (o(), u("svg", T1, F1)) : (o(), u("svg", P1, O1))
                    ], 2)
                  ])) : _("", !0)
                ])
              ]),
              L.value == "filters" ? (o(), X(rn, {
                key: 0,
                class: "border-y border-gray-200 dark:border-gray-800 py-8 my-2",
                definitions: s(h),
                columns: I.value,
                onDone: U[6] || (U[6] = (ke) => L.value = null),
                onChange: ge
              }, null, 8, ["definitions", "columns"])) : _("", !0),
              ie.value ? (o(), u("div", j1, [
                fe(on, {
              ...
              k.value.error ? (o(), X(re, {
                key: 2,
                status: k.value.error
              }, null, 8, ["status"])) : C.value ? (o(), X(xe, { key: 3 })) : (o(), u("div", B1, [
                    ...
                    header: ve(({ column: ke, label: Ee }) => {
                      ...
                      return [
                        e.allowFiltering && (!t.canFilter || t.canFilter(ke)) ? (o(), u("div", E1, [
                          n("span", H1, S(Ee), 1),
                          fe(we, {
                            column: I.value.find((rt) => rt.name.toLowerCase() === ke.toLowerCase()),
  ...
  setup(e) {
    const l = e, t = c(() => Object.keys(l.tabs)), a = (h) => l.label ? l.label(h) : Ie(h), i = c(() => l.id || "tabs"), r = c(() => l.param || "tab"), d = F();
    function v(h) {
      if (d.value = h, l.url) {
        const g = t.value[0];
        ql({ tab: h === g ? void 0 : h });
    ...
    return lt(() => {
      ...
      n("div", q1, [
        ...
        n("select", {
          ...
          onChange: g[0] || (g[0] = (y) => {
            var k;
            return v((k = y.target) == null ? void 0 : k.value);
          })
        }, [
        ...
        n("div", Z1, [
          n("nav", J1, [
            (o(!0), u(be, null, $e(s(t), (y) => (o(), u("a", {
              href: "#",
              onClick: je((k) => v(y), ["prevent"]),
              style: El({ width: s(m) }),
              class: w([f(y) ? "border-indigo-500 text-indigo-600 py-4 px-1 text-center border-b-2 font-medium text-sm" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 py-4 px-1 text-center border-b-2 font-medium text-sm", e.tabClass])
            }, S(a(y)), 15, X1))), 256))
          ])
        ])
      ]),
  ...
  setup(e) {
    ...
    let t = F(l == null ? void 0 : l.classList.contains("dark"));
    function a() {
  ...
  emits: ["login"],
  setup(e, { emit: l }) {
    const t = e, { getMetadata: a, createDto: i } = Je(), r = yl(), { signIn: d } = an(), v = a({ assert: !0 }), f = v.plugins.auth, m = document.baseURI, h = v.app.baseUrl, g = F(i("Authenticate")), y = F(new Ze());
    lt(() => {
      f == null || f.authProviders.map((j) => j.formLayout).filter((j) => j).forEach((j) => j.forEach((P) => g.value[P.id] = ""));
    });
    const k = c(() => (f == null ? void 0 : f.authProviders.filter((j) => j.formLayout)) || []), b = c(() => k.value[0] || {}), C = c(() => k.value[Math.max(k.value.length - 1, 0)] || {}), L = c(() => (t.provider ? f == null ? void 0 : f.authProviders.find((j) => j.name === t.provider) : null) ?? b.value), V = (j) => j === !1 || j === "false";
    function D(j) {
      return j.label || j.navItem && j.navItem.label;
    }
    const B = c(() => {
      var j;
      return (((j = L.value) == null ? void 0 : j.formLayout) || []).map((P) => {
        var N, K;
        return Object.assign({}, P, {
          type: (N = P.type) == null ? void 0 : N.toLowerCase(),
          autocomplete: P.autocomplete || (((K = P.type) == null ? void 0 : K.toLowerCase()) === "password" ? "current-password" : void 0) || (P.id.toLowerCase() === "username" ? "username" : void 0),
          css: Object.assign({ field: "col-span-12" }, P.css)
        });
      });
    }), Q = c(() => V(t.oauth) ? [] : (f == null ? void 0 : f.authProviders.filter((j) => j.type === "oauth")) || []), $ = c(() => {
      let j = na(
        f == null ? void 0 : f.authProviders.filter((N) => N.formLayout && N.formLayout.length > 0),
        (N, K) => {
          let G = D(K) || Ye(K.name);
          N[G] = K.name === b.value.name ? "" : K.name;
        }
      );
      const P = L.value;
      return P && V(t.tabs) && (j = { [D(P) || Ye(P.name)]: P }), j;
    }), R = c(() => {
      let j = B.value.map((P) => P.id).filter((P) => P);
      return y.value.summaryMessage(j);
    });
    async function E() {
      if (g.value.provider = L.value.name, y.value = await r.api(g.value), y.value.succeeded) {
        const j = y.value.response;
        d(j), l("login", j), y.value = new Ze(), g.value = i("Authenticate");
      }
    }
    return (j, P) => {
      const N = q("ErrorSummary"), K = q("AutoFormFields"), G = q("PrimaryButton"), te = q("Icon"), I = Ns("href");
      return s(f) ? (o(), u("div", om, [
        n("div", im, [
          n("h2", rm, S(e.title), 1),
          Object.keys(s($)).length > 1 ? (o(), u("p", um, [
            n("span", dm, [
              (o(!0), u(be, null, $e(s($), (p, T) => gt((o(), u("a", {
                class: w([
                  p === "" || p === s(b).name ? "rounded-l-md" : p === s(C).name ? "rounded-r-md -ml-px" : "-ml-px",
        ...
        n("div", cm, [
          ...
          n("div", fm, [
            ...
            s(Q).length ? (o(), u("div", hm, [
              gm,
              n("div", pm, [
                (o(!0), u(be, null, $e(s(Q), (p) => (o(), u("div", null, [
                  n("a", {
